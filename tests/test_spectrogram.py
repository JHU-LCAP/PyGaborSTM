...
class TestAuditorySpectrogram:
    ...
    def test_silence_near_zero(self, audio_silence):
        ...
        result = stm.auditory_spectrogram(audio_silence)
    ...
    def test_noise_has_broadband_energy(self, audio_noise):
        ...
        result = stm.auditory_spectrogram(audio_noise)
    ...
    def test_times_axis(self, audio_tone, sr):
        result = stm.auditory_spectrogram(audio_tone)
    ...
    def test_short_signal(self, audio_short):
        ...
        result = stm.auditory_spectrogram(audio_short)
        assert result.n_times > 0

    def test_custom_config(self, audio_tone):
        cfg = stm.SpectrogramConfig(n_filters=64)
        result = stm.auditory_spectrogram(audio_tone, config=cfg)
